`           <main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Riwayat Ajuan Lelang</h1>
							...
							<div class="card">
                                ...
                                <div class="card-body">
                                    <?php $bgLight = true; ?>
                                        ...
                                        <?php if($da['lelang_diajukan'] == 1 && $da['lelang_dimenangkan'] == 0) : ?>
                                        <?php if ($bgLight) : ?>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-3 ">
                                                    ...
                                                    <?php endif; ?>
                                                    <a href="<?= base_url() ?>lelang/lihatLelang/<?= $da['id'] ?>/<?= $da['id_mobil'] ?>" class="btn btn-warning lihat-ajuan mt-1"><i data-feather="eye"></i></a>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <?php if($da['lelang_dimenangkan'] == 1) : ?>
